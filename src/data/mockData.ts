...
export const products: Product[] = [
    ...
    // Ош - Интеграции (B2B)
    {
        id: '9', name: 'Integration Hub', category: 'Интеграции', revenue: 1567890, deals: 43,
    ...
    {
        id: '10', name: 'Marketing Automation', category: 'Маркетинг', revenue: 2345670, deals: 156,
    ...
    // Талас - Поддержка (B2C)
    {
        id: '11', name: 'Support Lite', category: 'Поддержка', revenue: 876543, deals: 287,
    ...
    {
        id: '12', name: 'Analytics Lite', category: 'Аналитика', revenue: 1234567, deals: 234,
...
export const crossSales: CrossSale[] = [
    ...
    { product1: 'CRM Enterprise', product2: 'Marketing Automation', count: 34 },
    ...
    // Ош паттерны
    { product1: 'Marketing Suite', product2: 'Integration Hub', count: 27 },
    { product1: 'Integration Hub', product2: 'Marketing Suite', count: 19 },
    // Кросс-региональные
    { product1: 'CRM Enterprise', product2: 'Support Desk', count: 38 },
    { product1: 'Marketing Suite', product2: 'LearnPlatform', count: 23 },
    { product1: 'Support Desk', product2: 'CRM Lite', count: 41 },
    { product1: 'CRM Lite', product2: 'LearnPlatform', count: 22 },
    { product1: 'LearnPlatform', product2: 'Support Lite', count: 18 },
    { product1: 'Analytics Lite', product2: 'LearnPlatform', count: 16 },
];
